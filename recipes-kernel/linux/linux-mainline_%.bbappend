...
do_patch_append() {
    ...
    os.system('/usr/bin/convert {0} -dither None -colors 224 -compress none -font {1}/SiseriffLTStd-Regular.otf -pointsize 16 -fill white -gravity south -annotate +0+16 "{2}-{3}" {0}.convert'\
