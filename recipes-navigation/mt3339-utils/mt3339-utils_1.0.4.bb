...
RDEPENDS_${PN} = "bash lsof python-argparse python-codecs python-curses python-io python-math python-pyserial python-subprocess python-terminal python-threading"
