...
IMAGE_INSTALL_append = " busybox \
                         ...
                         bbu dtc fbgrab fbtest glibc-utils htop less lsof memtester mtd-utils-tests nano ncurses-tools nmon picocom rsyslog sudo systemd-extra-utils systemd-journal-upload util-linux-ldattach \
"
