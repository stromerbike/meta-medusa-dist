...
IMAGE_INSTALL_append = " \
                         ...
                         acl bluez-tools can-utils dtc fbgrab fbset fbtest glibc-utils gps-utils htop iftop iperf3 less mtd-utils-tests nano ncurses-tools nmon procps screen systemd-extra-utils tree \
"
