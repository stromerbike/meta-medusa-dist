...
IMAGE_INSTALL_append = " busybox \
                         ...
                         bbu bluez5-noinst-tools dtc fbgrab fbtest glibc-utils htop less lsof memtester mtd-utils-tests nano ncurses-tools nmon rsyslog sudo systemd-extra-utils systemd-journal-upload \
"
